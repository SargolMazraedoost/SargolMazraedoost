...
### Computational Chemist · AI Researcher · Molecular Modeler

Postdoctoral Research Fellow at Pukyong National University
...
I work at the intersection of computational chemistry, artificial intelligence, molecular modeling, and data-driven scientific discovery.
...
- Biomass fractionation modeling
- Bond dissociation energy prediction

## Tools and Technologies

`Python` · `PyTorch` · `RDKit` · `Scikit-learn` · `GROMACS` · `YASARA` · `AutoDock Vina` · `DFT`
